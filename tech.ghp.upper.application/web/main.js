...
(function() {
	...
	var MODULE = angular.module('tech.ghp.upper',
			[ 'ngRoute', 'ngResource' ]);

	MODULE.config( function($routeProvider) {
		$routeProvider.when('/', { controller: mainProvider, templateUrl: '/tech.ghp.upper/main/htm/home.htm'});
		$routeProvider.when('/about', { templateUrl: '/tech.ghp.upper/main/htm/about.htm'});
